    ...
    <div ref={vantaRef} className="app-container">
      <div className="content-wrapper">
        ...
        <div className="social-links">
          <a href="https://github.com/andrewcheriananil" className="cyberpunk-link" target="_blank" rel="noopener noreferrer">GitHub</a>
          <a href="mailto:aca.andrewcanil@gmail.com" className="cyberpunk-link">Email</a>
          <a href="https://linkedin.com/in/andrewcheriananil" className="cyberpunk-link" target="_blank" rel="noopener noreferrer">LinkedIn</a>
        </div>
      </div>
